  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center bg-white font-tajawal">
      <div className="text-center p-8 max-w-md">
        ...
        <h2 className="font-headline-md text-headline-md mb-2">حدث خطأ في صفحة الدفع</h2>
        <p className="text-on-surface-variant text-sm mb-6">يرجى المحاولة مرة أخرى أو العودة إلى السلة.</p>
